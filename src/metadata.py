...
DISAGGREGATIONS_TO_TITLES = {
    ...
    "escuela_publica_por_municipio": "Respuesta por unidad geográfica, escuela pública",
    "escuela_privada_por_municipio": "Respuesta por unidad geográfica, escuela privada",
}
